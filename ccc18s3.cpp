 ...
 * By: Dan Shan
 * for cameras turn every . or S on the same row or col to W until blocked
 * BFS from start marking each . reached as v
 * if a conveyor is encountered then push index is said direction if blocked continue loop
 * if pushed on conveyor over 10000 times assume infinite loop
 * for all v print depth for dots print -1
 */
#include <bits/stdc++.h>
using namespace std;
int main() {
